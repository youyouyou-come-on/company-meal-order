...
提醒建议配置为午餐 `09:30`、`09:50` 和晚餐 `15:00`、`15:20`。脚本会先统计当天对应餐次已经提交点餐的员工人数，如果低于 5 人，会认为今天可能是休假日或异常低活跃日，直接跳过提醒，避免误打扰全员。这个 5 人判断不区分员工是否绑定钉钉 UserId；真正发送时只会发给已绑定 UserId 的未点餐员工。
