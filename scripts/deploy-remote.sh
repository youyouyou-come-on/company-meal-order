...
DINGTALK_DINNER_REMINDER_FIRST_CRON="${DINGTALK_DINNER_REMINDER_FIRST_CRON:-0 15 * * 1-6}"
DINGTALK_DINNER_REMINDER_SECOND_CRON="${DINGTALK_DINNER_REMINDER_SECOND_CRON:-20 15 * * 1-6}"
...
核心环境变量：
  ...
  DINGTALK_DINNER_REMINDER_FIRST_CRON  晚餐首次提醒 cron，默认 "0 15 * * 1-6"
  DINGTALK_DINNER_REMINDER_SECOND_CRON 晚餐二次提醒 cron，默认 "20 15 * * 1-6"
